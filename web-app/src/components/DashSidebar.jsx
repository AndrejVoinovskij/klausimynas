...
const DashSidebar = () => {
  ...
  return (
    <Sidebar theme={customTheme}  className="w-full md:w-56 h-fit">
      <Sidebar.Items>
        <Sidebar.ItemGroup className="flex flex-col gap-1 mt-0 pt-1 items-center">
            <ul className="hidden md:flex md:flex-col items-left">
            ...
            <button className="space-y-2 group md:hidden">
              <h1 class="block font-sans text-base antialiased font-medium leading-relaxed h-[20px] text-blue-gray-900">Meniu</h1>
